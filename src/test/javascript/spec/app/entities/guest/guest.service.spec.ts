    ...
    describe('Guest Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/guests';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Guest', () => {
                service.create(new Guest(null)).subscribe(received => {
            ...
            it('should update a Guest', () => {
                service.update(new Guest(123)).subscribe(received => {
