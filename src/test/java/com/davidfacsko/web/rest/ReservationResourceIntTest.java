...
import com.davidfacsko.service.ReservationService;
import com.davidfacsko.service.dto.ReservationDTO;
import com.davidfacsko.service.mapper.ReservationMapper;
...
public class ReservationResourceIntTest {
    ...
    public void createReservation() throws Exception {
        ...
        assertThat(testReservation.getCheckIn()).isEqualTo(DEFAULT_CHECK_IN);
        assertThat(testReservation.getCheckOut()).isEqualTo(DEFAULT_CHECK_OUT);
    }
    ...
    public void updateReservation() throws Exception {
        ...
        Reservation testReservation = reservationList.get(reservationList.size() - 1);
        assertThat(testReservation.getCheckIn()).isEqualTo(UPDATED_CHECK_IN);
        assertThat(testReservation.getCheckOut()).isEqualTo(UPDATED_CHECK_OUT);
    }
